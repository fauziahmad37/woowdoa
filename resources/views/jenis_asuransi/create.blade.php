      ...
      <div class="container mx-auto w-full px-4">
        ...
        <nav class="text-gray-700 text-sm mb-6" aria-label="Breadcrumb">
            <ol class="list-reset flex flex-wrap items-center">
                ...
                <li class="flex items-center">
                    <span class="text-gray-500">Tambah Jenis Asuransi Baru</span>
                </li>
            </ol>
        </nav>

        <!-- Judul -->
        <h2 class="text-xl font-semibold text-gray-700">Tambah Jenis Asuransi Baru</h2>
        <p class="text-gray-500 mb-6">Silakan isi Data .</p>
...
<div class="flex justify-center mb-4">
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h2 class="text-lg font-semibold text-gray-800 text-center">Simpan Data Berhasil!</h2>
        <p class="mt-2 text-sm text-gray-600 text-center">Anda dapat membuat kembali data lainnya atau melhat data yang sudah dibuat</p>
        <div class="mt-6 flex flex-col sm:flex-row justify-center gap-3">
            <!-- Buat Data Lain -->
            <button onclick="reloadForm()"
                class="px-4 py-2 button-cancel text-white rounded-lg hover:bg-orange-600">
                Buat Data Lain
            </button>
            <!-- Selesai -->
            <a href="{{ route('jenis_asuransi.index') }}"
                class="px-4 py-2 button-add text-white rounded-lg hover:bg-orange-700">
                Selesai
            </a>
        </div>
    </div>
...
<script>
    ...
    function reloadForm() {
        window.location.href = "{{ route('jenis_asuransi.create') }}";
    }
</script>
@endpush
