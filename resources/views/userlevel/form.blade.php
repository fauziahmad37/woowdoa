				...
				<ol class="list-reset flex flex-wrap items-center">
						...
						<li>
								<span class="text-gray-500">
										{{ isset($userlevel) ? 'Edit Data User Level' : 'Tambah User Level' }}
								</span>
						</li>
				</ol>
		</nav>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
	...
	<div>
			...
			<input type="text" name="user_level_name"
						 value="{{ old('user_level_name', $userlevel->user_level_name ?? '') }}"
						 class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500">
			@error('user_level_name')
	...
	<div>
			<label class="block text-gray-700 font-medium mb-1">
				...
				@foreach($parents as $parent) 
						...
						@if(isset($parent->sub_menu) && $parent->sub_menu->count() > 0)
								@foreach($parent->sub_menu as $child) 
										<div class="checkbox">
